...
- `build/report.json` — portable Product Report v11 generated by
  `blueprint export`.
...
Product Report v11 adds an `objects` collection and its count. Each Object
...
`domainId`. Object states are authored lifecycle; a Screen's `productStates`
