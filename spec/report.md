...
- `build/report.json` — portable Product Report v10 generated by
  `blueprint export`.
...
`build/report.json` is a Product Report with `schemaVersion: "10.0.0"`. It
...
Product Report v10 stores `capabilityScenarios` and `journeyScenarios` as
