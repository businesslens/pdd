...
- `build/report.json` — portable Product Report v13 generated by
  `blueprint export`.
...
The raw `supportingContent` string field is not part of Product Report v13.
...
Product Report v13 has one collection for things: `entities`. There is no
...
Product Report v13 stores the Context-only schema the folder format uses.
...
other local References. Asset binaries are not part of Product Report v13.
...
Entity, and Capability consistency holds. Product Report v13 is the only
