...
| Terminal | `npx businesslens view` | View the current Product Model, or a GitHub repository's, privately on localhost, with Coverage and read-only Git comparisons |
