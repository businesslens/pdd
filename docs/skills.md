...
| [`businesslens-verify`](./skill-businesslens-verify.md) | You need branch, named, or current-state model/code alignment | Nothing during classification; approved resolution and optional bookmark bookkeeping |
