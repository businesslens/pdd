...
- **Explore:** propose ranked, genuinely different product directions and write
  nothing.
- **Converge:** draft actors, experiences, optional Screens, features, rules,
  journeys, scenarios, relationships, and removals; get approval; then write.
...
breadth, and codeRefs remain optional navigation.
