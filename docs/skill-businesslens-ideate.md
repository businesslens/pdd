...
- **Explore:** propose ranked, genuinely different product directions and write
  nothing.
- **Converge:** draft Actors, Interfaces, Experiences, optional Screens and
  Domains, Capabilities, Rules, Journeys, Scenarios, exact availability, and
  removals; get approval; then write.
...
plan/build flow injected between ideate and verify. Coverage describes model
breadth, while References remain optional attachments.
