...
├── build/                   # generated portable project — never committed
...
- `cache/analysis.json` — resumable state for an active platform publish.
- `build/project.json` — portable project generated by `build` and submitted
  by `publish`.
