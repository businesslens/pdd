...
under one list of expandable documentation pages. CLI-owned definitions remain
in the documentation index and generated registry, outside the panel's browsing
and search. Each header
