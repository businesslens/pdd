...
/**
 * The element box every Product Report graph is built from.
 *
...
.blr-flow-node__icon {
  ...
  width: calc(var(--blr-element-mark-regular) + 0.5rem);
  height: calc(var(--blr-element-mark-regular) + 0.5rem);
  flex-shrink: 0;
  border-radius: 8px;
...
.blr-flow-node.is-focus .blr-flow-node__icon {
  width: calc(var(--blr-element-mark-regular) + 0.75rem);
  height: calc(var(--blr-element-mark-regular) + 0.75rem);
}
