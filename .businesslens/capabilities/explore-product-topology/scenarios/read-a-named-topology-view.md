...
- The view that asks what changes what reads the Steps, not the Capabilities: an arc from a Capability to a thing exists only because one of its Steps creates, changes, or removes it.
